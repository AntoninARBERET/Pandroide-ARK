...
ARK Docker is a Docker image created at the ISIR, Sorbonne Université to provide an environment for ARK including all of the library it needs. It requires a Linux distribution to be used. It has been tested with Ubuntu 18.04.
